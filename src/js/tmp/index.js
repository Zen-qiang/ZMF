 ...
 * @Last Modified time: 2018-05-30 14:51:15
 */
var Weixin = (function () {
...
var ZMF = (function (doc) {
  ...
  const $textArr = [
    { 'name': '吃货桶', 'des': '没错，你就是那个万众挑一的饭桶！面对美食你向来是来者不拒，毫无抵抗力！有你在的饭局，垃圾桶的参与感为零。' },
    { 'name': '巨星桶', 'des': '如果生活是一个垃圾桶，你就是那个被所有回收站争抢的矿泉水瓶。如果生活是一场热波音乐节，你就是万人宠爱的毛不易；拥有强大气场的你走到哪里都是人群中最出挑的那一个巨星。' },
    { 'name': 'IQ桶', 'des': '小机灵鬼儿，你是团队内的智慧担当，没有你想不明白的问题，门萨俱乐部的入会测试对你来说也只是小菜一碟。真想掀起你的头盖骨…啊不是，掀起你的盖子，看看里面都装了些什么。' },
    { 'name': '摇滚桶', 'des': '谁说垃圾桶只能安安静静地待在角落？内心如你般热血而愤怒，任何东西都能用来表达自我！你的生活不能没有音乐，哪怕身边没有吉他，敲打敲打自己的盖子你也能立马高歌一曲！' },
    { 'name': '逗笔桶', 'des': '你是所有朋友口中的小逗笔，有你的地方就有笑声！派对由你来活跃气氛准没错，你的字典里压根没有“冷场”这两个字！我们打算派你的朋友去和戴佩妮PK掐大腿了…' },
    { 'name': '桃花桶', 'des': '有一个神奇的传说，和你做朋友的人都会在3个月内脱单。你简直就是红娘本娘！一直在有心无心地促成朋友圈共同好友之间的一段段姻缘。截图给你的那些单身狗朋友们看吧，3个月后他们会回来感谢你的。' },
    ...
    { 'name': '魔鬼桶', 'des': '你拥有小恶魔般的性格，总是有些邪恶但不失可爱的小想法，比如在别人坐下的瞬间把凳子抽掉；比如偷偷地把别人的SKII换成卸妆水；比如看到这里，你想问候一下这个游戏的设计者。' },
